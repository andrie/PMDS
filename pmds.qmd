...
-  Going from PowerBI / excel to a `shiny` dashboard
...
![](images/book-strategyzer-value-proposition-design.png)
:::
...
{{< qrcode https://andrie.quarto.pub/pmds-londonr/ height=300 width=300 >}}
::: {.r-stack}
<https://andrie.quarto.pub/pmds-londonr/>
:::
